...
function App() {
  ...
  const [currentFruit, setCurrentFruit] = useState<IFruit | null>(null); // nesse estado já esta diferente, pq esse estado tambem ficar null, entao na logica colocamos que ele pode ser o Ifruit tanto quanto null
